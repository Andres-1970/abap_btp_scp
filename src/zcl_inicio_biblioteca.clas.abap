CLASS zcl_inicio_biblioteca DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_inicio_biblioteca IMPLEMENTATION.
METHOD if_oo_adt_classrun~main.

DATA: lt_acc_categ TYPE TABLE OF ztb_acccateg4638,
      lt_catego    TYPE TABLE OF ztb_catego_4638,
      lt_clientes  TYPE TABLE OF ztb_clientes4638,
      lt_clnts_lib TYPE TABLE OF ztb_clntslib4638,
      lt_libros    TYPE TABLE OF ztb_libros_4638.
...
DELETE FROM ztb_acccateg4638.
INSERT ztb_acccateg4638 FROM TABLE @lt_acc_categ.
...
( bi_categ = 'H' descripcion = 'Geografía, historia' ) ).
"Delete possible entries; insert new entries
DELETE FROM ztb_catego_4638.
INSERT ztb_catego_4638 FROM TABLE @lt_catego.
******** ZTB_CATEGO ********
"fill internal table
lt_clientes = VALUE #(
...
"Delete possible entries; insert new entries
DELETE FROM ztb_clientes4638.
INSERT ztb_clientes4638 FROM TABLE @lt_clientes.
******** ZTB_CLNTS_LIB ********
lt_clnts_lib = VALUE #(
...
"Delete possible entries; insert new entries
DELETE FROM ztb_clntslib4638.
INSERT ztb_clntslib4638 FROM TABLE @lt_clnts_lib.
...
"Delete possible entries; insert new entries
DELETE FROM ztb_libros_4638.
INSERT ztb_libros_4638 FROM TABLE @lt_libros.
